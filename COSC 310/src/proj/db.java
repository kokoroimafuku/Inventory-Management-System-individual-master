...
public class db {
	...
	public String listProductString(){
		String name = "";
		String date = "";
		String quantity = "";
		String value = "";
		...
		try{
			...
			while(rst.next()){
				...
				name = name + ", " +rst.getString("productName");
				date = date + ", " +rst.getDate("expiryDate");
				quantity = quantity + ", " +rst.getInt("quantity");
				value = value + ", " +rst.getDouble("productValue");
	...
	public Object[][] listLowInventryProducts(){
		...
		try{
			...
			while(rst.next()){
				data[count][0]=rst.getString("productName");
				data[count][1]=rst.getDate("expiryDate").toString();
				data[count][2]=Integer.toString(rst.getInt("quantity"));
				data[count][3]=Double.toString(rst.getDouble("productValue"));
				count++;
			}
